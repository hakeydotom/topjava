...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static List<MealWithExceed> getFilteredWithExceeded(List <Meal> meals, int calories) {
        return getFilteredWithExceeded(meals, LocalTime.of(0,0), LocalTime.of(23,59), calories);
    }
